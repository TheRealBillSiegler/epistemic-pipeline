...
- **Conformal "I don't know" has a real bound but hard limits.** Conformal abstention (Abbasi-Yadkori et al., NeurIPS 2024) bounds the error rate via self-consistency, but the bound is *marginal/in-expectation*, *fails under distribution shift*, and the paper concedes it "clearly cannot detect situations where the LLM is completely sure about an incorrect answer."
...
- Conformal abstention (bound + limits) — Abbasi-Yadkori et al., NeurIPS 2024: [arXiv:2405.01563](https://arxiv.org/abs/2405.01563)
