# MCS-D -- Unified Canonical Specification (v1.0-Complete)

**Form:** Fully merged, lossless, hierarchical canonical spec
**Purpose:** Single authoritative reference for the entire
epistemic pipeline architecture
...
- Multi-paradigm reasoning (Bayes, STRIPS, Search, MDPs)
- LLMs and tools as controlled cognitive processes
- Adaptive meta-epistemic control
- Fully auditable, replayable, and explainable
...
- timestamp
- confidence in [0,1]
- etype in {observation, report, measurement}
- modality in {text, sensor, tool, LLM}
...
`f_i: EpistemicState -> EpistemicState`
...
`monitor(trace, scores, ontology, strategy,
decomposition) -> MetaDecision`
